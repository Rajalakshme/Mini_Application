...
class Main{
    private static final String train_name = "Chennai Express";
    private static final String train_num = "CS1801";
    ...
    private static void admin() {
        System.out.println("\t\t\t\t\t\tWelcome IRCTC Admin");
        System.out.print("Enter Admin Id:");
        int admin_id = scan.nextInt();
        System.out.print("Enter Admin Password:");
        int admin_pass = scan.nextInt();

        if (admin_id == 01 && admin_pass == 12345) {
            ...
            System.out.println("Booking Details for Chennai Express");
            System.out.println();
    ...
    private static void user_signup() {
        ...
        System.out.println("Remember Log in credentials!!!");
        user_id++;
    ...
    private static void confirm_seat(int no, int stop, int arr) {
        ...
        lb1: for (int j = 0; j < 3; j++) {
            ...
            if (sum == 0) {
                ...
                System.out.println(
                        " Seat Allocated for User " + user_list.get(index).u_name + " Your Seat Number is " + j +
    ...
    private static void userList() {
        user_list.add(new users("Sam", "1234", "9999999999", 10000, 93));
        user_list.add(new users("Ram", "5678", "8888888888", 9000, 92));
        user_list.add(new users("Nitya", "1234", "9999988888", 3000, 90));
    }
